...
// Get the image name, and print it out to your screen (if desired, not necessary but can be helpful). 
...
//  Max project each channel (this is assuming 4 channels, but you can change as needed), and measure the entire channels intensity.
...
// this is for the first channel. A pre-defined box size will populate, but you need to move it to a desired location. Then this location will be auto applied to the other channles.
